...
/**
 * OBottomTabBar — Persistent bottom navigation tab bar
 *
 * Moved from BottomTabBar.tsx → organisms/OBottomTabBar.tsx.
 * 4 tabs: Pour Moi, Ressources, Messagerie, Mes informations.
 * Screenshots: IMG_3702, IMG_3762
 */

export interface OBottomTabBarProps {
...
export default function OBottomTabBar({ activeTab, onTabChange }: OBottomTabBarProps) {
    return (
        <div
            style={{
                position: "sticky",
