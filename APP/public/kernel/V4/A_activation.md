# 📄 TEMPLATE A — Activation — V4 Fragilité du Proche
...
|---|---|---|---|
| V4_F1_CCC_01 | E21 = « Non, un changement sera nécessaire » **ET** (N21 = « Oui » **OU** N9 = « Oui ») | Vie quotidienne non tenable + fragilités financières/gestion | Legacy ✅ |

#### 🟢 Standard

| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F1_STD_01 | E21 ∈ {Non, Je ne sais pas} | Maintien situation sans changement impossible | Legacy ✅ |
| V4_F1_STD_02 | O51 = « Oui » | Projet adaptation lieu de vie | Legacy ✅ |
...
| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F2_CCC_01 | ≥ 2 parmi : E23 ∈ {≤1h, Ne peut pas rester seul}, E24=Oui, O8=Oui, O9=Oui | Dépendance fonctionnelle élevée nécessitant réorganisation urgente | Legacy ✅ |

#### 🟢 Standard

| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F2_STD_01 | E24 = « Oui » | Besoin présence la nuit | Legacy ✅ |
| V4_F2_STD_02 | E23 ∈ {≤1h, Ne peut pas rester seul} | Temps possible seul très limité | Legacy ✅ |
...
| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F3_CRIT_01 | E27 = « Oui » | Comportements dangereux pour le proche ou l'aidant | Legacy ✅ |
| V4_F3_CRIT_02 | N22 = « Oui » | Comportements à risque — mise en danger | Legacy ✅ |

#### 🟠 CCC

| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F3_CCC_01 | O13 ∈ {Diminution notable, Altération totale} **ET** (E25=Oui **OU** E26=Oui) | Désorganisation cognitive installée avec retentissement fonctionnel | Legacy ✅ |
...
| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F4_CRIT_01 | N25 = « Oui » | Idées suicidaires — risque vital immédiat | Legacy ✅ |
| V4_F4_CRIT_02 | N38 = « Oui » | Perte de contrôle addiction | Legacy ✅ |
| V4_F4_CRIT_03 | N39 = « Oui » | Violence passive ou active | Legacy ✅ |

#### 🟠 CCC

| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F4_CCC_01 | ≥ 2 parmi : N11=Oui, N12=Oui, N13=Oui, N34=Oui, O4=Déprimée | Dégradation somato-psychique globale par accumulation | Legacy ✅ |
...
| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F5_CCC_01 | E28 ≥ 2 **ET** O53 = « Non » | Instabilité médico-sociale avec épisodes aigus sans cadre | Legacy ✅ |

#### 🟢 Standard

| Règle ID | Condition | Sens clinique | Source |
|---|---|---|---|
| V4_F5_STD_01 | E28 ≥ 2 | Hospitalisations récentes ≥ 2 | Legacy ✅ |
